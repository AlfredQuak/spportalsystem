 ...
 * \defgroup systemcore
 * \details
 * Systemcore iss your basic class set
 * \mainpage spPortalSystem Main Page
 *
 * <b>s</b>im<b>p</b>el PortalSystem was coding by Daniel Stecker since 2008
 *
 *
 * This manual is divided in the following sections:
 *
 * - \subpage howto_install
 * - \subpage howto_writemodul
 *
 */
define('SP_PROFILE', false);

if (!file_exists('config.inc.php')) {
    header('Location: ' . substr($_SERVER['PHP_SELF'], 0, strpos($_SERVER['PHP_SELF'], "/index.php")) . '/install/step1.php');
} else {
    require_once 'config.inc.php';
    if (SP_CORE_DEBUG > SP_LOG_NOTHING) {
