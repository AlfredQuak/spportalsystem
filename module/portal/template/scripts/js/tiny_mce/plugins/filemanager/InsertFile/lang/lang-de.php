...
$MY_MESSAGES['nopermtodeletefile'] = 'Keine ausreichende Berechtigung zum Loeschen der Datei.';
$MY_MESSAGES['filenotfound'] = 'Datei nicht gefunden.';
$MY_MESSAGES['unlinkfailed'] = 'Loeschen fehlgeschlagen.';
$MY_MESSAGES['rmdirfailed'] = 'Verzeichnis loeschen fehlgeschlagen.';
$MY_MESSAGES['nopermtodeletefolder'] = 'Keine ausreichende Berechtigung zum Loeschen des Verzeichnisses.';
$MY_MESSAGES['foldernotfound'] = 'Verzeichnis nicht gefunden.';
$MY_MESSAGES['foldernotempty'] = 'Verzeichnis ist nicht leer.\nBitte loeschen Sie zuerst alle darin enthaltenen Dateien.';
...
$MY_MESSAGES['filesizeexceedlimit'] = 'Datei ueberschreitet die zulaessige Kapazitaet.';
...
$MY_MESSAGES['deletefile'] = 'Datei loeschen';
$MY_MESSAGES['deletefolder'] = 'Verzeichnis loeschen';
$MY_MESSAGES['refresh'] = 'Aktualisieren';
$MY_MESSAGES['folder'] = 'Verzeichnis';
$MY_MESSAGES['type'] = 'Typ';
$MY_MESSAGES['name'] = 'Name';
$MY_MESSAGES['size'] = 'Groesse';
$MY_MESSAGES['datemodified'] = 'Geaendert am';
$MY_MESSAGES['url'] = 'Pfad';
$MY_MESSAGES['comment'] = 'Kommentar';
$MY_MESSAGES['caption'] = 'Text';
$MY_MESSAGES['upload'] = 'Hochladen';
$MY_MESSAGES['insertfile'] = "Datei einfuegen";
$MY_MESSAGES['filemanager'] = "Datei Manager";
$MY_MESSAGES['directory'] = "Verzeichnis";
$MY_MESSAGES['enterurl'] = "Bitte geben Sie eine URL ein.";
$MY_MESSAGES['entercaption'] = 'Bitte geben Sie einen Text fuer die Datei ein.';
$MY_MESSAGES['inserticon'] = 'Icon fuer Dateityp hinzufuegen';
$MY_MESSAGES['insertsize'] = 'Angaben ueber Dateigroesse hinzufuegen';
$MY_MESSAGES['insertdate'] = 'Angaben ueber Änderungsdatum hinzufuegen';
