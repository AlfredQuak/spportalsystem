...
<FORM action="{PORTAL_HTTP_HOST}/?modul=admin&action=portal_CMSUpdateNews&newsid={portal_newsId}" method="post" encType="multipart/form-data">
    <table width="100%">
        <tr>
            <th >
                <span class="genmed">
                    <div>{LANG_portal_sideName}</div>
                </span>
            </th>
        </tr>
        <tr>
            <td>
                <table width="100%">
                    <tr >
                        <td valign="top" >
                            <span class="genmed">
                                <div allign="top"><input name=side_titel value="{portal_valueSideTitel}" size=“32“></div>
                            </span>
                        </td>
                        <td >
        ...
        <tr>
            <td valign="top">
                <span class="genmed">
                    <div>
                        <textarea id="elm2" name="side_content" rows="30" cols="80" style="width: 100%">
    {portal_valueSideContent}
                        </textarea>
                    </div>
                </span>
            </td>
