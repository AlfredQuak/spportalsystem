...
<FORM action="{PORTAL_HTTP_HOST}/?modul=admin&action=portal_CMSEditSide&doit=editPageUpdate&id={portal_pageid}" method="post" encType="multipart/form-data">
    ...
    <table width="100%">
            ...
            <td>
                <table width="100%">
                    <tr>
                        <td valign="top">
                            <span class="genmed">
                                <div allign="top"><input name="side_titel" value="{portal_pageTitel}" size=“32“></div>
                            </span>
                        </td>
                        <td>
                            <div align="right">
                                <nobr>{LANG_portal_underSide} <select name="side_subside">{portal_underside}</select></nobr>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td valign="top">
                <span class="genmed">
                    <div>
                        <textarea id="page_{portal_pageid}" name="side_content" rows="20" cols="80" style="width: 100%">
                    {portal_pageContent}
                        </textarea>
                    </div>
                </span>
