...
<FORM action="{PORTAL_HTTP_HOST}/?modul=admin&action=portal_newBox" method="post" encType="multipart/form-data">
      <table width="100%">
        <tr>
                ...
                <table width="100%">
                    <tr>
                        <td valign="top"><span class="genmed">
                                <div allign="top"><input name=box_titel value="" size=“32“></div>
                            </span></td>
                        <td></td>
                    </tr>
                </table>
