...
<FORM action="{PORTAL_HTTP_HOST}/?modul=admin&action=portal_CMSWriteNews" method="post" encType="multipart/form-data">
            ...
            <td>
                <table width="100%">
                    <tr >
                        <td valign="top" >
                            <span class="genmed">
                                <div allign="top"><input name=side_titel value="" size=“32“></div>
                            </span>
                        </td>
                        <td >
                        </td>
