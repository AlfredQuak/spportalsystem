	<ul id="Navigation">
        <li><h1>System Info</h1></li>
        <li>.:: {LANG_admin_version}</li>
	<li>.:: Counter : {admin_counter}</li>
	<li><h1>.:: {LANG_admin_TmenuSystemSettings}</h1></li>
	<!--<li><a href="?modul=admin&action=admin_lang">Sprache</a></li>-->
	...
	<li><h1>.:: {LANG_admin_TmenuModulSettings}</h1></li>
	...
	<li><h1>.:: {LANG_admin_TmenuUserManagemant}</h1></li>
